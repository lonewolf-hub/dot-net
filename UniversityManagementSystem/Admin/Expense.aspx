<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Expense.aspx.cs" Inherits="UniversityManagementSystem.Admin.Expense" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div >
        ...
        <div class="container p-md-4 p-sm-4 ">
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No record to Display!" AutoGenerateColumns="False" AllowPaging="true" PageSize="10" DataKeyNames="ExpenseId" OnRowEditing="GridView1_RowEditing"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Charge Rs.(Per Lecture)">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtExpenseAmt" runat="server" Text='<%#Eval("ChargeAmount") %>' TextMode="Number" CssClass="form-control"></asp:TextBox>
